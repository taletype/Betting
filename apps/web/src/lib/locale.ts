...
const en: LocaleCopy = {
  ...
  research: {
    ...
    loadError: "Market data temporarily unavailable.",
    ...
    openOnPolymarketUnavailable: "Polymarket source link unavailable",
    ...
    readinessCopy: {
      ...
      beta_user_not_allowlisted: "Beta trading is limited to allowlisted users",
      wallet_not_connected: "Wallet not connected",
      wallet_funds_insufficient: "Wallet funds insufficient",
      credentials_missing: "Set Polymarket trading permissions",
      ...
      ready_to_submit: "Prepare order (user signature required)",
...
const zhHK: DeepPartial<LocaleCopy> = {
  ...
  auth: {
    ...
    magicLinkNotice: "登入連結已發送，請檢查你的電郵。",
  ...
  ambassador: {
    ...
    paidRewards: "已支付獎勵",
    teamMembership: "推薦資格",
    noTeamMembership: "推薦紀錄只作直接歸因及報表用途。",
  ...
  research: {
    ...
    loadErrorDetails: {
      ...
      external_markets_not_implemented: "市場資料暫時不可用。",
