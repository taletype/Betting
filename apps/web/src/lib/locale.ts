...
const en: LocaleCopy = {
  ...
  ambassador: {
    ...
    safeNotice: "There is no participation fee, no multi-level referral reward, no guaranteed profit, and the platform does not bet or trade for users.",
  ...
  research: {
    ...
    subtitle: "Reference pricing from Polymarket and Kalshi. External Polymarket routing remains non-custodial and user-signed.",
...
const zhHK: DeepPartial<LocaleCopy> = {
  ...
  portfolio: {
    ...
    requestWithdrawalHint: "輸入金額及目標錢包，以建立 {network} 測試網提款申請。",
  ...
  wallet: {
    ...
    linkWallet: "連結錢包",
    relinkWallet: "重新連結錢包",
    noWalletDetected: "未偵測到錢包。請安裝 Coinbase Wallet 或 MetaMask 進行 Base Sepolia 測試。",
  ...
  research: {
    title: "外部市場",
    subtitle: "參考 Polymarket 及 Kalshi 價格。外部 Polymarket 路由維持非託管，訂單由用戶自行簽署。",
