...
test("readiness model enumerates disabled states", () => {
  ...
  assert.equal(getPolymarketRoutingReadiness({ hasBuilderCode: false, featureEnabled: true, walletConnected: true, hasCredentials: true, userSigningAvailable: true, userSigned: true, marketTradable: true, submitterAvailable: true }), "builder_code_missing");
  assert.equal(getPolymarketRoutingReadiness({ hasBuilderCode: true, featureEnabled: false, walletConnected: true, geoblockAllowed: true, hasCredentials: true, userSigningAvailable: true, userSigned: true, marketTradable: true, orderValid: true, submitterAvailable: true }), "feature_disabled");
  assert.equal(getPolymarketRoutingReadiness({ hasBuilderCode: true, featureEnabled: true, betaUserAllowlisted: false, walletConnected: true, geoblockAllowed: true, hasCredentials: true, userSigningAvailable: true, userSigned: true, marketTradable: true, orderValid: true, submitterAvailable: true }), "beta_user_not_allowlisted");
  ...
  assert.equal(getPolymarketRoutingReadiness({ hasBuilderCode: true, featureEnabled: true, walletConnected: true, geoblockAllowed: true, hasCredentials: true, userSigningAvailable: true, userSigned: true, marketTradable: false, orderValid: true, submitterAvailable: true }), "market_not_tradable");
  assert.equal(getPolymarketRoutingReadiness({ hasBuilderCode: true, featureEnabled: true, walletConnected: true, geoblockAllowed: true, hasCredentials: true, userSigningAvailable: true, userSigned: true, marketTradable: true, orderValid: false, submitterAvailable: true }), "invalid_order");
  assert.equal(getPolymarketRoutingReadiness({ hasBuilderCode: true, featureEnabled: true, walletConnected: true, geoblockAllowed: true, hasCredentials: true, userSigningAvailable: true, userSigned: true, marketTradable: true, orderValid: true, submitterAvailable: false }), "submitter_unavailable");
