...
export const getAdminPolymarketStatusPayload = async (
  ...
  return {
    ...
    syncSummary: {
      ...
      lastSyncDurationMs: toNumber(lastFullDiagnostics.durationMs as number | string | null | undefined),
      pagesFetchedLastFullSync: toNumber(lastFullDiagnostics.pagesFetched as number | string | null | undefined),
      nextOffsetLastFullSync: typeof lastFullDiagnostics.nextOffset === "number" ? lastFullDiagnostics.nextOffset : null,
      ...
      lastFullSyncCompleted: lastFullDiagnostics.completed === true,
    },
    preflight,
    syncCadence: {
