...
const withEventDefaults = (event: PolymarketEvent, market?: PolymarketMarket): PolymarketMarket => ({
  ...
  accepting_orders: market?.accepting_orders ?? event.accepting_orders,
  acceptingOrders: market?.acceptingOrders ?? event.acceptingOrders,
  enable_order_book: market?.enable_order_book ?? event.enable_order_book,
  enableOrderBook: market?.enableOrderBook ?? event.enableOrderBook,
  orderBookEnabled: market?.orderBookEnabled ?? event.orderBookEnabled,
